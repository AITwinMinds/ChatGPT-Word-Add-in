...
Public Sub theExplaining(control As IRibbonControl)

    Dim request As Object
    Dim text As String, response As String, API As String, DisplayText4 As String, error_result As String
    ...
    additionalPrompt = "Explain the following text: "
    ...
    If status_code = 200 Then
      ...
      DisplayText4 = ExtractContent(response)
      Dim rephrasedForm4 As New UserForm1
      rephrasedForm4.lblRephrasedText.text = DisplayText4
      rephrasedForm4.lblRephrasedText.Value = DisplayText4
      rephrasedForm4.Show vbModal
    
      
' Check the user's response
    Select Case rephrasedForm4.Tag
        Case "Insert"
            ' Replace the selected text with the response
            selectedText.text = DisplayText4
        Case "Cancel"
            Exit Sub
    End Select
    ...
    Else
        ...
        If startPos > Len("""message"": """) And endPos > startPos Then
            DisplayText4 = Mid(response, startPos, endPos - startPos)
        ...
        EDisplayText = "Error : " & DisplayText4
        'selectedText.InsertAfter vbNewLine & EDisplayText
        MsgBox EDisplayText, vbExclamation
